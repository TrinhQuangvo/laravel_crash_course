    ...
    <div class="w-6/12 mt-3 bg-white p-6 rounded-lg">
        <form action="{{route('register')}}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="password_confirmation" id="password_confirmation" placeholder="Repeat Your Password" class=" @error('name') border-red-500  @enderror bg-gray-100 border-2 w-full p-4 rounded-lg">
                @error('name')
                <div class="text-red-500 mt-2 text-sm">
                    {{ $message }}
                </div>
